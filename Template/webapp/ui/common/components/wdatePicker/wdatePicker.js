...
$(function() {
	...
	$('.Wdate').focus(function() {
		...
		var _minDate = "1900-01-01 00:00:00";
		var _maxDate="2099-12-31 23:59:59";
		var _dchanged =null;
		var _mchanged =null;
		var _ychanged =null;
		var _onpicked =null;
		...
		if ($(this).attr("dateFmt")) {
			_dateFmt = $(this).attr("dateFmt");
		}
		if ($(this).attr("minDate")) {
			_minDate = $(this).attr("minDate");
		}
		if ($(this).attr("maxDate")) {
			_maxDate = $(this).attr("maxDate");
		}
		if ($(this).attr("dchanged")) {
			var dch = $(this).attr("dchanged");
			_dchanged = eval(dch);
			_mchanged = eval(dch);
			_ychanged = eval(dch);
		}
		if($(this).attr("oncleared")){
			var ych = $(this).attr("oncleared");
			_oncleared = eval(ych);
		}
		if($(this).attr("onpicked")){
			var ych = $(this).attr("onpicked");
			_onpicked = eval(ych);
		}
		WdatePicker({
			el: this,
